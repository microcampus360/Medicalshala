     ...
     />
          <div className="w-full " style={divStyle}>
               ...
               <div className="p-20 flex flex-col gap-2 justify-center items-center sm:block ">
                ...
                <h1 className="font-bold text-3xl text-blue-900">Expert Second Medical Opinion</h1>
            <h3 className="">Get a second medical opinion for treatments, surgeries or reports from our board certified doctors across the world.</h3>
                 ...
                 <span className="text-blue-700 font-semibold"> { country === 'India' ? <> <span> ₹999.00 </span> </>   : <span>$99.00</span> } </span>
                ...
                <div className="flex flex-col">
                    ...
                    <span className="text-blue-700 font-semibold"> ₹7,500.00 </span>
